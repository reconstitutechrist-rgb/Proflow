...
export default function ThreadedConversation({
  ...
  return (
    ...
    <Card className="border-l-4 border-blue-500 h-full flex flex-col">
      {' '}
      ...
      <CardContent className="flex-1 flex flex-col overflow-hidden">
        ...
        <div className="space-y-3 mb-4 flex-1 overflow-y-auto pr-2">
          {' '}
          {/* Added flex-1 and overflow for scrolling messages */}
          {loading ? (
            <div className="text-center py-4 text-gray-500">Loading messages...</div>
          ) : messages.length > 0 ? (
            messages.map(
              (
                message // Render fetched messages
              ) => (
                <div key={message.id} className="flex items-start gap-3">
                  ...
                  <div className="flex-1 min-w-0">
                    <div className="flex items-center gap-2 mb-1">
                      ...
                      {message.reply_to && <Reply className="w-3 h-3 text-gray-400" />}
                    </div>
        ...
        <div className="mt-auto pt-3 border-t flex-shrink-0">
          {' '}
          {/* Stick to bottom, prevent shrinking */}
