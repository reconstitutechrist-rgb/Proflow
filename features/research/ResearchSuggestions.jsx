        ...
        <CardContent>
          <div className="text-center p-6 bg-gradient-to-r from-blue-50 to-indigo-50 rounded-lg border border-blue-200">
            ...
            <p className="text-sm text-blue-700 dark:text-blue-300 mb-4">
              Click any question below for instant AI research, or ask your own questions in the
              chat.
            </p>
      ...
      <Card className="border-l-4 border-l-red-500 shadow-md">
        ...
        <CardContent className="space-y-4">
          {suggestions.immediate.map((category, categoryIndex) => (
            <div
              key={categoryIndex}
              className={`border rounded-lg p-4 ${category.color} dark:bg-opacity-20`}
            >
                ...
                {category.questions.map((question, questionIndex) => (
                  ...
                  >
                    <div className="flex items-center gap-2">
                      ...
                      <span className="text-wrap text-sm text-gray-700 dark:text-gray-300">
                        {question}
                      </span>
                    </div>
                  </Button>
