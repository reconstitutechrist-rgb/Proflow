...
const DOCUMENT_TEMPLATES = [
  {
    ...
    prompt:
      'Generate a comprehensive assignment brief with project overview, objectives, scope, key deliverables, timeline, and success metrics.',
  },
  {
    id: 'technical-spec',
    ...
    prompt:
      'Create a technical specification with system architecture, component breakdown, requirements, and deployment considerations.',
  },
  {
    id: 'project-plan',
    title: 'Project Plan',
            ...
            <div className="max-w-4xl mx-auto">
              <div className="text-center mb-8">
                ...
                <p className="text-gray-600">
                  Select a template and let AI create a professional document for you
                </p>
              </div>
                  ...
                  >
                    ...
                    >
                      <CardHeader className="pb-2">
                        <div
                          className={`w-10 h-10 rounded-lg bg-gradient-to-br ${template.color} flex items-center justify-center mb-2`}
                        >
                  ...
                  <Card>
                    <CardContent className="p-6 space-y-4">
                      ...
                      <div className="flex items-center gap-2">
                        ...
                        />
                        <label htmlFor="gen-tasks" className="text-sm cursor-pointer">
                          Generate related tasks (Coming Soon)
                        </label>
                      </div>
                      <Button
                        onClick={handleGenerateFromTemplate}
                        disabled={isGenerating || !templateTitle.trim() || !customPrompt.trim()}
