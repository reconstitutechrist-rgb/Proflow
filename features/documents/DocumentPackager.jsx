  ...
  const handleCreatePackage = async () => {
    ...
    try {
      ...
      if (documentsToPackage.length !== selectedDocuments.length) {
        console.error(
          'Security violation: Some selected documents were not found in available (workspace-filtered) documents.'
        );
        toast.error(
          'A security check failed. Some selected documents could not be validated. Please refresh and try again.'
        );
        return;
      }
              ...
              <div className="space-y-2">
                ...
                {loading ? (
                  ...
                  <div className="text-center py-8 text-gray-500">
                    ...
                    <p className="text-sm">
                      No documents available for this assignment in your current workspace.
                    </p>
                  </div>
                ) : (
                ...
                <div className="flex items-start gap-2">
                  ...
                  <div>
                    ...
                    <p className="text-xs text-blue-700 dark:text-blue-400 mt-1">
                      Only documents from the current workspace can be included in this package. All
                      selected documents will be validated before packaging.
                    </p>
                  </div>
                </div>
              </div>
            ...
            <div>
              ...
              <div className="mt-2 space-y-3">
                <div className="flex items-center space-x-2">
                  ...
                  />
                  <Label htmlFor="password-protected-checkbox" className="text-sm">
