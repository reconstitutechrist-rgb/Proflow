        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          ...
          <div>
            ...
            <Select
              ...
              onValueChange={(value) =>
                setTaskData({ ...taskData, assignment_id: value === 'none' ? null : value })
              } // Set to null if "none" selected
            ...
            >
              ...
              <SelectContent>
                ...
                {assignmentsList &&
                  assignmentsList.map(
                    (
                      a // Using local state 'assignmentsList'
                    ) => (
          ...
          <div>
            ...
            <Select
              ...
              onValueChange={(value) =>
                setTaskData({ ...taskData, assigned_to: value === 'none' ? null : value })
              } // Set to null if "none" selected
            >
              <SelectTrigger>
