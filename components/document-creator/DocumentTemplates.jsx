...
export default function DocumentTemplates({ assignment, onTemplateSelect }) {
  const documentTemplates = [
    {
      ...
      difficulty: "Easy",
      sections: ["Assignment Overview", "Goals & Objectives", "Scope", "Timeline", "Team", "Budget"]
    },
    {
      ...
      difficulty: "Medium",
      sections: ["Functional Requirements", "Non-functional Requirements", "User Stories", "Acceptance Criteria"]
    },
    {
      id: "project_proposal",
      ...
      difficulty: "Medium",
      sections: ["Executive Summary", "Problem Statement", "Proposed Solution", "Timeline", "Budget", "Team"]
    },
    {
      id: "meeting_minutes",
    ...
    },
    {
      ...
      difficulty: "Medium",
      sections: ["Risk Identification", "Impact Analysis", "Probability Assessment", "Mitigation Strategies"]
    },
    {
      id: "status_report",
      title: "Status Report",
    ...
    },
    {
      ...
      difficulty: "Advanced",
      sections: ["Introduction", "Getting Started", "Features", "Troubleshooting", "FAQ", "Support"]
    }
  ];
  ...
  const getCategoryColor = (category) => {
    switch (category) {
      ...
      case 'Documentation': return 'bg-teal-100 text-teal-800';
      default: return 'bg-gray-100 text-gray-800';
    }
  };
      ...
      <Card className="border-0 shadow-sm bg-green-50">
        ...
        <CardContent>
          <p className="text-sm text-green-700 mb-3">
            Select a template to generate a professional document using your assignment context and AI assistance.
          </p>
          {assignment && (
              ...
              <div className="flex items-start gap-4">
                ...
                <div className="flex-1 min-w-0">
                  ...
                  <div className="flex items-center gap-3 mb-3">
                    ...
                    <Badge className={getDifficultyColor(template.difficulty)} variant="secondary" size="sm">
                      {template.difficulty}
                    </Badge>
                  </div>
