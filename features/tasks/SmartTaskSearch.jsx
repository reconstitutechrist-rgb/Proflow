...
Return as JSON array of 5-8 keywords.`;
        ...
        const results = tasks.filter((task) => {
          const searchableText = [
            ...
            .filter(Boolean)
            .join(' ')
            .toLowerCase(); // Filter out null/undefined values before joining
    ...
    [tasks]
  ); // Re-run if the base tasks list changes
      ...
      <div className="relative">
        ...
        <Input
          placeholder={
            loading
              ? 'Loading tasks...'
              : 'AI-powered task search with skills and workflow matching...'
          }
          value={searchQuery}
